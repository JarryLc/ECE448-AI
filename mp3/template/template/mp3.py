...
if __name__ == "__main__":
    ...
    parser.add_argument('--training', dest='training_dir', type=str, default = 'F:/ECE Grad FALL2019/ECE 448/mp3/template/template/train',
                        help='the directory of the training data')
    parser.add_argument('--development', dest='development_dir', type=str, default = 'F:/ECE Grad FALL2019/ECE 448/mp3/template/template/dev',

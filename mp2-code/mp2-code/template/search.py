...
def bfs(maze):
    ...
    while flag:
        ...
        if len(maze.offsets) == 1:
            # print(type(queue[i].position[0]))
            neighbors = maze.getNeighbors(queue[i].position[0])
        elif len(maze.offsets) == 2:
            neighbors = maze.getNeighbors(queue[i].position[0], queue[i].position[1])
        else:
            neighbors = maze.getNeighbors(queue[i].position[0], queue[i].position[1], queue[i].position[2])
